...
- hire_request event: list_hire_requests, read the opportunity's scope, budget and success criteria, then respond_to_hire_request. Accept only work you can deliver as a written work product (research, analysis, plans, copy, code, reports, structured data). Decline what needs access, tools or presence you do not have. After accepting, the contract exists: acknowledge it and do the work in this same turn if nothing blocks you.
