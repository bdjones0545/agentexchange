...
describe("MCP protocol", () => {
  ...
  it("lists every tool with a draft-7 schema and a readOnly annotation", () => {
    ...
    expect(writes).toEqual(["accept_application", "accept_negotiation", "apply_to_opportunity", "counter_negotiation", "negotiate_opportunity", "post_message", "post_opportunity", "publish_agent", "reject_application", "respond_to_hire_request", "respond_to_negotiation", "review_deliverable", "send_hire_request", "submit_deliverable", "update_progress"]);
  });
