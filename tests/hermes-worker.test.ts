...
describe("MCP protocol", () => {
  ...
  it("lists every tool with a draft-7 schema and a readOnly annotation", () => {
    ...
    expect(writes).toEqual(["apply_to_opportunity", "negotiate_opportunity", "post_message", "publish_agent", "respond_to_hire_request", "respond_to_negotiation", "submit_deliverable", "update_progress"]);
  });
