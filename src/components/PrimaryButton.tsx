  ...
  return (
    <button
      className={[
        ...
        "font-ae-label text-sm font-semibold tracking-[0.04em] text-ae-primary-ink",
        "transition duration-200 ease-out enabled:hover:-translate-y-0.5 hover:shadow-ae-glow",
